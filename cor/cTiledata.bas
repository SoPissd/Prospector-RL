...
declare function init_tiles(tiles() as _tile) as Integer
declare function set_movecost(tiles() as _tile,iMoveCost as Integer) as short
...
function set_movecost(tiles() as _tile,iMoveCost as Integer) as short
	dim as integer i
	dim as _tile t	
	for i=1 to dimTiles
		t=tiles(i)
		'if t.movecost=0 then 
		t.movecost=iMoveCost
	next
	return true
End Function


function init_tiles(tiles() as _tile) as Integer
